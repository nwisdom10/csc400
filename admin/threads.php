						...
						if($result['totalResult']>0){
							foreach($result['allData'] as $data){
								...
								<tr>
									...
									<td>
										<span>
											<a href="delete-thread.php?threadid=<?php echo $data['topic_id']; ?>&title=<?php echo $data['title']; ?>" class="text-danger" onclick="return confirm('Are you sure to delete this?')"><i class="fa fa-times"></i></a>
										</span>
									</td>
								</tr>
								<?php
